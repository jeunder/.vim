...
alias mkcscope='find -name "*.c" -o -name "*.h" -o -name "*.cc" -o -name "*.cpp" -o -name "*.hpp" -o -name "*.c++" -o -name "*.h++" -o -name "*.s" -o -name "*.S" -o -name "*.asm" -o -name "*.inc" > cscope.files && cscope -Rbqk'
